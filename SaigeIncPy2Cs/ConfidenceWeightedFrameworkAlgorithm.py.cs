...
public static class ConfidenceWeightedFrameworkAlgorithm {
    
    static ConfidenceWeightedFrameworkAlgorithm() {
        AddReference("System");
    ...
    public class ConfidenceWeightedFrameworkAlgorithm
        ...
        public virtual object Initialize() {
            ...
            this.SetPortfolioConstruction(ConfidenceWeightedPortfolioConstructionModel());
