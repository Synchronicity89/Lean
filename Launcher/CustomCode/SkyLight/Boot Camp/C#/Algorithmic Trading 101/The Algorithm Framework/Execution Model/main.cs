namespace QuantConnect
{
    ...
    public partial class ExecutionModel : QCAlgorithm
    {
        public override void Initialize()
        {
			...
			var symbols = new [] {QuantConnect.Symbol.Create("SPY", SecurityType.Equity, Market.USA), QuantConnect.Symbol.Create("BND", SecurityType.Equity, Market.USA)};
